...
import com.github.tand0.naiview.databinding.ActivityTreeBinding;
import com.github.tand0.naiview.adapter.JSONListAdapter;
...
public class TreeActivity extends AppCompatActivity {
    ...
    private void loadForASFResult(Uri imageUri) {
        ...
        try (InputStream is = cd.openInputStream(imageUri)) {
            if (is == null) {
