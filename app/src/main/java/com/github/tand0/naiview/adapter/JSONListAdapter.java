...
import com.github.tand0.naiview.SuggestActivity;
import com.github.tand0.naiview.data.Data;
import com.github.tand0.naiview.MyApplication;
import com.github.tand0.naiview.data.PromptType;
import com.github.tand0.naiview.R;
import com.github.tand0.naiview.TreeActivity;
    ...
    public void createDefaultTree() {
        ...
        for (PromptType promptType: PromptType.values()) {
            ...
            String[] strings = switch (promptType) {
                case P_BASE_OK -> MyApplication.DEFAULT_PROMPT.split(",");
                case P_BASE_NG -> MyApplication.DEFAULT_PROMPT_UC.split(",");
                default -> new String[]{};
            };
